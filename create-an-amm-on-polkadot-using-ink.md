# Create an AMM on Polkadot using Ink!
...
* You should go through [ink! beginners guide](https://docs.substrate.io/tutorials/v3/ink-workshop/pt1/)
...
> The above code is just a reference on how to interact with the smart contract from the frontend.
